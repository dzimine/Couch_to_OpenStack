####################################
# Courtesy https://gist.github.com/jgeurts/3112065
#
# BASIC REQUIREMENTS
...
#####
sudo sed -i 's/WSGISocketPrefix run\/wsgi/WSGISocketPrefix \/etc\/httpd\/wsgi/' /etc/apache2/sites-available/default
